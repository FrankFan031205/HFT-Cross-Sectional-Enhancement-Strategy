...
ROOT="/mnt/data1/fwz/HFT_010-dev_fwz_outputs/final_report/v25_core_active_sleeve_csi2000_v7"
TAG="pure_cs_v25_core095_active025_target20_exec10_csi2000"
...
echo "===== v25 optimizer start =====" | tee "$LOG"
date | tee -a "$LOG"
